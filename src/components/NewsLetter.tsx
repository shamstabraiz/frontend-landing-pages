...
function NewsLetter() {
    return (
        <div className="max-w-[1078px] max-sm:p-3 gap-3 w-[100%] bg-[#096260] rounded-t-7xl min-h-[180px] flex flex-row justify-center items-center">
            <div className="w-[40%] max-sm:w-[100%]  flex flex-col flex-wrap justify-end">
                ...
                <h6 className="w-[max-content] max-sm:w-[100%] ">and Never Miss an Update from Vibe Sign</h6>
            </div>
